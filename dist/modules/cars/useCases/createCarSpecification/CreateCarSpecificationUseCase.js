...
let CreateCarSpecificationUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(carsRepository, specificatonsRepository) {
    this.carsRepository = carsRepository;
    this.specificatonsRepository = specificatonsRepository;
  }
  ...
  async execute({
    ...
    const specifications = await this.specificatonsRepository.findByIds(specifications_id);
